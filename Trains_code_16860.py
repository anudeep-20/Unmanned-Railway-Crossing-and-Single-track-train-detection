        ...
        for x in range(0,len(parsed)):
            ...
            if (msg.latitude != 0 or msg.longitude != 0):
                for i in train_arr:
                    ...
                    aio_tra.send('trains-private-feeds.16860', str(msg.latitude) + ',' + str(msg.longitude))#Here the train No.: 16860, which can be changed by creating a Private feed corresponding to that Train No.
                    time.sleep(2)
